...
<head>
    ...
    <title>@yield('title') | HungPham HawkVendor</title>
                        ...
                        <form action="shop">
                            <div class="advanced-search">
                                ...
                                <div class="input-group">
                                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Bạn muốn tìm gì ?">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <ul>
                            <li>Văn Thành, Yên Thành, Nghệ An</li>
                            <li>Phone: 0962 604 756</li>
                            <li> Email: hungluonyt@gmail.com</li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text">
                            ...
                            </script>View này code bởi Hungluonyt <i class="fa fa-heart-o"></i>
                        </div>
