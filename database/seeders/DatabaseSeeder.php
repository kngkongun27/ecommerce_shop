    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            [
                'id' => 1,
                'name' => 'HungPham',
                'email' => 'hungluonyt@gmail.com',
                'password' => Hash::make('123456'),
                'avatar' => null,
                'level' => 2,
                'description' => null,

                'company_name' => 'HawkVendor',
                'country' => 'Viet Nam',
                'street_address' => 'Phan Huy Ich, Hung Binh, TpVinh',
                'postcode_zip' => '10000',
                'town_city' => 'Ha Noi',
                'phone' => '024 634 3555',
            ],
        ...
        DB::table('users')->insert([
            ...
            [
                ...
                'avatar' => 'avatar-0.png',
                'level' => 1,
                'description' => 'Mô tả này sẽ thêm vào sau '
            ],
            [
                'id' => 4,
                'name' => 'Thiện Trương',
                'email' => 'thientruong@gmail.com',
                'password' => Hash::make('123456'),
                'avatar' => 'avatar-1.png',
                'level' => 1,
                'description' => null,
